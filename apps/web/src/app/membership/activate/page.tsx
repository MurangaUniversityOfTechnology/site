  ...
  return (
    <main className="grid min-h-[calc(100vh-64px)] place-items-center px-5 py-14 sm:px-8">
      <div className="w-full max-w-120">
        <div className="font-mono text-[10.5px] uppercase tracking-[0.18em] text-accent">step 01 of 02 · review</div>
        ...
        <div className="mt-7 overflow-hidden rounded-xl border border-border bg-surface">
          <div className="flex items-start justify-between gap-4 border-b border-[#161c1e] p-5.5">
            <div>
          ...
          <div className="grid grid-cols-1 gap-2.5 p-5.5 sm:grid-cols-2">
            {membershipPerks.map((perk) => (
              <div key={perk} className="flex items-baseline gap-2.5 text-[14.5px] text-[#c8d2cc]">
        ...
        <div className="mt-4 text-center font-mono text-[10.5px] leading-[1.7] text-[#5d6a64]">
          a club admin reviews your application after payment is confirmed
        </div>
      </div>
    </main>
  );
