...
export default function WaitingPage() {
  ...
  return (
    <main className="relative grid min-h-[calc(100vh-64px)] place-items-center overflow-hidden px-5 py-14">
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-130 w-130 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(61,250,138,.06),transparent_62%)]" />

      <div className="relative max-w-100 text-center">
        {!unknown ? (
          <>
            <div className="relative mx-auto grid h-19.5 w-19.5 place-items-center rounded-full border border-[#1f2729]">
              <div className="absolute -inset-px animate-spin rounded-full border-2 border-transparent border-t-accent" />
              <span className="font-mono text-[9.5px] uppercase tracking-[0.1em] text-[#5d6a64]">stk</span>
            </div>
            <h1 className="mt-7.5 text-[clamp(26px,3.6vw,36px)] leading-[1.1] tracking-[-0.03em]">Check your phone</h1>
            <p className="mt-4 text-base leading-[1.6] text-[#c8d2cc]">
              We&apos;ve sent an M-Pesa request to your phone.
            </p>
            <p className="mt-3 text-[15px] leading-[1.55] text-[#7f8d87]">
          ...
          <>
            <div className="mx-auto grid h-16 w-16 place-items-center rounded-full border border-[#3a3226] bg-warn/10 font-mono text-xl text-warn">
              ?
            </div>
            ...
            <button
              ...
              className="mt-6 rounded-lg bg-accent px-6.5 py-3.5 text-[15px] font-semibold text-[#04140b] hover:opacity-90"
            >
              Check Again
            </button>
          </>
